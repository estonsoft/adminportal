...
const TestimonialsList = () => {
  ...
  const handleDelete = async (testimonialId) => {
    ...
    try {
      const response = await fetch(`http://localhost/new.php/testimonials/${testimonialId}`, {
        method: "DELETE",
        headers: {
  ...
  const handleUpdateTestimonial = async (updatedTestimonialData) => {
    ...
    try {
      const response = await fetch(`http://localhost/new.php/testimonials/${editingTestimonial.id}`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
          Authorization: token,
